...
public class Frame2 extends JFrame {
	JButton jLabel1,jLabel2,jLabel3,jLabel4,jLabel5,jLabel6,jButton;
	JTextArea jArea;
	  Connection con = ConnectDb.connect();
	  Statement sql; 
      ResultSet rs;
	 Frame2(String n1,String n2) {
		 setSize(630, 500);
		 ...
		 jLabel4=new JButton("最高分");
		 jLabel5=new JButton("最低分");
		 jLabel6=new JButton("平均分");
		 jButton=new JButton("最低分位次");
		 jArea=new JTextArea();
		 ...
		 layout.setConstraints(jButton, c);
		 add(jLabel1);
		 add(jLabel2);
		 add(jLabel3);
		 add(jLabel4);
		 ...
		 try { 
	          ...
	          rs=sql.executeQuery("SELECT *FROM school2  where 年份 like '"+ n1+"'"+" and 省份 like'"+n2+"'"); //查询school2表
	          while(rs.next()) {
